...
public class PonTreeAi : MonoBehaviour
{
    ...
    private void ConstructBehaviourTree()
    {
        ...
        BTSelector findPlayerSelector = new BTSelector(new List<BTNode> { findMoveNode, findMoveNode2 });
        BTSelector moveSelector = new BTSelector(new List<BTNode> { findPlayerSelector, moveNode });

        topNode = new BTSequence(new List<BTNode> {  ponSetDirNode, waitNode, moveSelector });
