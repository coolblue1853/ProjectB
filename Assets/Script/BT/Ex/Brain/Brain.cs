...
public class Brain : MonoBehaviour
{
    ...
    BTSequence AttackNode;
    BTSequence PatrolNode;
    BTSequence ChaseNode;
    ...
    private void ConstructBehaviourTree_Slime()
    {
     ...
     //   AttackNode = new BTSequence(new List<BTNode> { doNothing2f_Attack, attack, endAttack, Eed });
 ...
 //       PatrolNode patrol = new PatrolNode(astarAI, this.transform.position, -4, 4, -4, 4);
  //      ChasePlayer chase = new ChasePlayer(astarAI, this);
     ...
     //   AttackNode = new BTSequence(new List<BTNode> { doNothing2f_Attack, chase, attack, Eed });
     //   PatrolNode = new BTSequence(new List<BTNode> { doNothing2f_Patrol, patrol, Eed });
    }
  ...
  //      PatrolNode patrol = new PatrolNode(astarAI, this.transform.position, -4, 4, -4, 4);
     //   ChasePlayer chase = new ChasePlayer(astarAI, this);
       ...
       // AttackNode = new BTSequence(new List<BTNode> { doNothing_Attack, checkNear, meleeAttack, Eed });
     //   ChaseNode = new BTSequence(new List<BTNode> { doNothing_Chase, chase, AttackNode, checkNear, Eed });
    ...
    private void ConstructBehaviourTree_EliteGhost()
    {
     //   EndNode Eed = new EndNode(this);
      ...
      //  PatrolNode patrol = new PatrolNode(astarAI, this.transform.position, -4, 4, -4, 4);
        ...
        //AttackNode = new BTSequence(new List<BTNode> { doNothing2f_Attack, patrol, checkNear, attack, Eed });
