...
public class EnemyWallCheck : MonoBehaviour
{
   ...
   public bool isGroundCheck = false;
    ...
    private void Update()
    {
        ...
        {
            hit2 = Physics2D.Raycast(groundCheck2.transform.position, Vector2.right, 0.3f, LayerMask.GetMask("Ground"));
            Debug.DrawRay(groundCheck2.transform.position, Vector2.right, Color.red, 0.3f);
